...
import euclid.operator_runtime.workflow as operator_workflow


def test_search_candidate_records_keep_non_admissible_candidates_ranked_for_descriptive_scope() -> None:
    candidate = operator_workflow._CandidateEvaluation(
        family_id="drift",
    ...
    records = operator_workflow._search_candidate_records((candidate,))
